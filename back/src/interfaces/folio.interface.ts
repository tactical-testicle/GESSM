export default interface IFolio {
    tipoFolio: string;               // ID del tipo de folio (clave foránea)
    ...
    subgerencia: string;            // ID o nombre de subgerencia, según modelo relacional
    superintendencia: string;       // ID o nombre de superintendencia
    ...
    destinatarios: string[];        // Lista de IDs de destinatarios
